...
/** A well-backed pro argument: green contour, diverging gauge right, positive sway. */
...
/** A rejected con argument: rust contour, gauge diverging left, negative sway. */
...
/** A draft still inside its locking window: open padlock with the countdown, no sway yet. */
