...
export const climateDebate: DebateScript = {
  ...
  steps: [
    ...
    // argument here the children make a stronger case for than its own market did.
    {
      ...
      side: 'pro',
      approval: 55,
      text: 'Cleaner air saves lives now',
    },
    ...
    },
    {
      ...
      side: 'pro',
      approval: 75,
      text: 'Damage estimates for unchecked warming dwarf the costs of mitigation.',
    },
    {
      kind: 'add',
      user: 'bob',
      key: 'uncertain-projections',
      parent: 'act-now',
      side: 'con',
      approval: 55,
    ...
    },
    {
      kind: 'add',
      user: 'bob',
      key: 'fossil-industrialization',
      parent: 'poor-countries',
      side: 'pro',
      approval: 65,
    ...
    },
    {
      ...
      side: 'pro',
      approval: 80,
      text: 'Fossil-fuel air pollution kills millions every year, whatever the climate does.',
    },
    ...
    // Level 3: replies to selected second-level arguments.
    {
      ...
      side: 'pro',
      approval: 75,
      text: 'Small island nations already face permanent submersion of inhabited land.',
    },
    {
      kind: 'add',
      user: 'dan',
      ...
      side: 'con',
      approval: 55,
      text: 'Attribution of migration to climate alone is contested; most moves have mixed causes.',
    },
    {
      kind: 'add',
      user: 'dan',
      key: 'pace-of-warming',
      parent: 'adapted-before',
      side: 'con',
      approval: 70,
      text: 'The projected pace of warming outstrips anything societies have adapted to before.',
    },
    {
      kind: 'add',
      user: 'dan',
      key: 'uncertainty-cuts-both-ways',
      parent: 'uncertain-projections',
      side: 'con',
      approval: 70,
      text: 'Uncertainty cuts both ways: damages could just as well be far worse than projected.',
    },
    {
      kind: 'add',
      user: 'dan',
      ...
      side: 'pro',
      approval: 65,
      text: 'Off-grid solar already powers tens of millions of homes across Africa and Asia.',
    },
    {
      kind: 'add',
      user: 'dan',
      key: 'storage-lags',
      parent: 'solar-cost-fall',
      side: 'con',
      approval: 60,
      text: "Cheap panels alone don't decarbonize grids; storage and transmission still lag.",
    },
    ...
    { kind: 'stake', user: 'erika', argument: 'habitability', side: 'pro', amount: 500 },
    { kind: 'stake', user: 'erika', argument: 'jobs', side: 'pro', amount: 200 },
    { kind: 'stake', user: 'erika', argument: 'uncertain-projections', side: 'con', amount: 200 },
    { kind: 'stake', user: 'erika', argument: 'innovation', side: 'con', amount: 300 },
    { kind: 'stake', user: 'frank', argument: 'innovation', side: 'con', amount: 200 },
    { kind: 'stake', user: 'frank', argument: 'adapted-before', side: 'con', amount: 400 },
    { kind: 'stake', user: 'frank', argument: 'displacement', side: 'pro', amount: 700 },
    { kind: 'stake', user: 'frank', argument: 'free-rider', side: 'con', amount: 100 },
    { kind: 'stake', user: 'frank', argument: 'fossil-industrialization', side: 'pro', amount: 300 },
    { kind: 'stake', user: 'alice', argument: 'act-now', side: 'pro', amount: 400 },
    { kind: 'stake', user: 'carol', argument: 'solar-cost-fall', side: 'pro', amount: 300 },
